...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: lemanum.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: lemanumd.pid)") + "\n";
